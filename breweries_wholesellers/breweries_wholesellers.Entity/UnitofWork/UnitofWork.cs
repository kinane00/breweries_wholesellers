...
namespace breweries_wholesellers.Entity.UnitofWork
{
    public interface IUnitOfWork : IDisposable
    {
        ...
        breweries_wholesellersContext Context { get; }
        int Save();
        Task<int> SaveAsync();
    }
    ...
    {
        public breweries_wholesellersContext Context { get; }

        private Dictionary<Type, object> _repositoriesAsync;
        private Dictionary<Type, object> _repositories;
        private bool _disposed;

        public UnitOfWork(breweries_wholesellersContext context)
        {
            Context = context;
            _disposed = false;
        }
